...
const QuizCard = ({ title, subject, time, date,passingpercentage,scoredpercentage}) => {
    return (
        <div className="relative min-w-72 max-w-[380px] border border-[#E6E6E6] rounded p-4 m-2">
        <div className="absolute right-0 top-0 text-xs sm:text-xs md:text-sm lg:text-sm flex items-center justify-center bg-[#abf7b1] text-[#11a56c] p-1 px-2 rounded w-[71px]  mr-0 ml-1">Passed</div> 
                ...
                <p className=" text-[#000000] text-xs sm:text-xs md:text-sm lg:text-sm p-1 -my-1.5">Scored Percentage <span className="text-[#11a56c]">{scoredpercentage}</span></p>
